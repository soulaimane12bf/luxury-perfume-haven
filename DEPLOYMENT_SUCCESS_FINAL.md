...
```env
# Database
POSTGRES_URL=postgresql://neondb_owner:npg_...@ep-[hidden].aws-us-east-1.aws.neon.tech/neondb?sslmode=require
DATABASE_URL=postgresql://neondb_owner:npg_...@ep-[hidden].aws-us-east-1.aws.neon.tech/neondb?sslmode=require
