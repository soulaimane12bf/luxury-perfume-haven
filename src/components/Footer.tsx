...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary text-primary-foreground mt-20">
      ...
      <div className="border-b border-gold/20 py-8 bg-green-600">
        <div className="container mx-auto px-4 text-center">
          <a
            href="https://wa.me/212600000000?text=مرحباً، أريد الاستفسار عن منتجاتكم"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-white text-green-600 px-8 py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform duration-300 shadow-lg"
          >
