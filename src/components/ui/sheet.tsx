...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn("text-lg font-semibold text-foreground dark:text-foreground", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description ref={ref} className={cn("text-sm text-foreground/70 dark:text-foreground/60", className)} {...props} />
));
