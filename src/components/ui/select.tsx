...
>(({ className, children, position = "popper", ...props }, ref) => (
    ...
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // Raise z-index above sheet/dialog overlays so the dropdown is visible
        // and interactive when used inside a Sheet/Dialog. The project's
        // SheetContent uses z-[200], so z-[250] keeps the select on top.
        // Ensure pointer events are enabled for the popup.
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          // Ensure a sensible minimum width so the dropdown is visible inside
          // the sheet even when radix trigger variables are not available.
          "p-1 min-w-[8rem] w-full",
