...
import { login, register, verifyToken, changePassword, requestPasswordReset, resetPassword, getMaskedAdminEmail, validateResetToken } from '../controllers/authController.js';
